...
<main class="atlas">
  ...
  <section class="atlas-library" aria-labelledby="atlas-library-title">
    ...
    <nav class="atlas-index" aria-label="アーキテクチャ領域">
      ...
      <a href="/ja/19-ml-systems/01-ml-system-fundamentals"><span>16</span><strong>MLシステム</strong><small>特徴量・サービング・ドリフト</small></a>
      <a href="/ja/16-llm-systems/01-agent-fundamentals"><span>17</span><strong>LLMシステム</strong><small>エージェントと文脈</small></a>
      <a href="/ja/17-graphql/01-graphql-fundamentals"><span>18</span><strong>GraphQL</strong><small>スキーマと連携</small></a>
      <a href="/ja/18-compound-engineering/01-compound-engineering-fundamentals"><span>19</span><strong>コンパウンドエンジニアリング</strong><small>AIネイティブワークフロー</small></a>
    </nav>
  </section>
